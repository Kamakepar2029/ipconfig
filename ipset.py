...
print('\n')
print('So what ip you want to set?')
stat = input('static/dynamic(s/d) > ')
print('What netmask you want to set? (X.X.X.X)')
netm = int(input('netmask> '))
print('What gateway do you want set')
gate = int(input('gateway> '))
name = int(input('nameserver(standart:8.8.8.8)> '))
names = int(input('dns-nameservers std(8.8.8.8 8.8.4.4)> '))
